    ...
    return (
        <div className="row px-3">
            ...
            <div className="col-md-12 dashboard_area">
                ...
                <ul className="list-unstyled">
                    <li className="user_list"><NavLink to="/" className="text-decoration-none px-2 py-2 rounded"><img className="me-2" src={User} alt={User} />Cards <img className="ms-5" src={Right} alt={Right}/></NavLink>                        
                    <ul className="list-unstyled mt-3 dropdown-container">
                        <li className="py-2 mb-1"><NavLink to="/" className="text-decoration-none" ><img className="me-2" src={Circle} alt={Circle} />Basic</NavLink></li>
                        <li className="py-2 mb-1"><NavLink to="/userview" className="text-decoration-none" ><img className="me-2" src={Circle} alt={Circle} />Statistics</NavLink></li>
                        <li className="py-2 mb-1"><NavLink to="/useredit" className="text-decoration-none w-100" ><img className="me-2" src={Circle} alt={Circle} />Analytics</NavLink></li>
                        <li className="py-2"><NavLink to="/useredit" className="text-decoration-none w-100" ><img className="me-2" src={Circle} alt={Circle} />Card Actions</NavLink></li>
                    </ul>
                    </li>
                </ul>
            </div>
